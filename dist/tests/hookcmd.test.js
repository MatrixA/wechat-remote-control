...
import { guardedHookCommand, hookEventsFor, shQuote, HOOK_MARK, mergeWrcHooks, wrcStatusLine, hookConfigFileFor, isWrcHookCommand, } from '../hookcmd.js';
...
test('statusLine round-trips: installed then stripped leaves settings clean', () => {
    const settings = { theme: 'dark', statusLine: wrcStatusLine(DIR) };
