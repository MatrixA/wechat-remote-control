...
import { tmuxSessionOf, effectiveFocus, orderedSessionNames, sanitizeSessionName, planTopicSync, } from '../sessions.js';
...
test('planTopicSync with focus: creates focused topics, removes out-of-focus ones, skips busy', () => {
    ...
    r.sessions.a1.imTarget = '-100:11';
    r.sessions.a1.topicName = 'a1';
    r.sessions.b1.imTarget = '-100:33';
    r.sessions.b1.topicName = 'b1';
...
test('planTopicSync with focus: hidden sessions get no topic and tombstones stay put', () => {
    ...
    r.sessions.a1.imTarget = '-100:11';
    r.sessions.a1.topicName = 'a1';
    r.sessions.a2.imTarget = '-100:22';
    r.sessions.a2.topicName = 'a2';
    assert.deepStrictEqual(planTopicSync(r), []);
