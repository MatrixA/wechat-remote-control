...
function getVoiceCdnData(voiceItem) {
...
function getFileCdnData(fileItem) {
...
function getVideoCdnData(videoItem) {
 ...
 */
export async function downloadImageToFile(item) {
    const imageItem = item.image_item;
    if (!imageItem)
        return null;
    const cdnData = getImageCdnData(imageItem);
 ...
 */
export async function downloadVoice(item) {
 ...
 */
export async function downloadVideo(item) {
