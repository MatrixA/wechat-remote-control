...
import { loadTelegramAccount, saveTelegramAccount, saveAllowedChat, saveOffset, loadOffset, } from './auth.js';
 ...
 */
export async function captureAuthorizedChat(token, opts = {}) {
    const api = new TelegramApi(token);
